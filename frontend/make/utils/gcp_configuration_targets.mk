...
_export_android_gcp_vars:
	...
	$(eval export GCP_ANDROID_SDK_KEY := $(shell echo '$(PROJECT_SECRETS_JSON)' | jq -r '.GCP_ANDROID_SDK_KEY'))
...
_export_ios_gcp_vars:
	...
	$(eval export GCP_IOS_SDK_KEY := $(shell echo '$(PROJECT_SECRETS_JSON)' | jq -r '.GCP_IOS_SDK_KEY'))
	@echo "[INFO] [Export Google Cloud Vars] iOS Google Cloud environment variables exported."

_android_gcp_configuration: _bws_project_secrets_json _export_android_gcp_vars

_ios_gcp_configuration: _bws_project_secrets_json _export_ios_gcp_vars
