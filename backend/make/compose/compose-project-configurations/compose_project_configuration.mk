...
COMPOSE_PROFILE_BUILD_PRE_SYNC := build_pre_sync
COMPOSE_PROFILE_APP_PRE := app_pre_async
...
COMPOSE_PROFILE_BUILD_PRE_SYNC_SERVICES = $(call get_profile_services,$(COMPOSE_PROFILE_BUILD_PRE_SYNC))
...
COMPOSE_BUILD_SERVICES = $(COMPOSE_PROFILE_APP_SERVICES) \
						 ...
						 $(COMPOSE_PROFILE_BUILD_PRE_SYNC_SERVICES) \
